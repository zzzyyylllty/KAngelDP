...
fun replaceTestTexts(str: String): String {
    ...
    val replaced = str
        .replaceUnrelocated("!top.maplex.arim","!io.github.zzzyyylllty.kangeldungeon.dep.arim")
        .replaceUnrelocated("!ink.ptms.um","!io.github.zzzyyylllty.kangeldungeon.dep.um")
        .replaceUnrelocated("!com.alibaba", "!io.github.zzzyyylllty.kangeldungeon.dep.alibaba")
        .replaceUnrelocated("!kotlinx.serialization", "!kotlinx.serialization170")
        .replaceUnrelocated("!io.github.projectunified.uniitem","!io.github.zzzyyylllty.kangeldungeon.dep.uniitem")
        .replaceUnrelocated("!com.fasterxml.jackson","!io.github.zzzyyylllty.kangeldungeon.dep.jackson")
        .replaceUnrelocated("!com.mojang.datafixers","!io.github.zzzyyylllty.kangeldungeon.dep.datafixers")
        .replaceUnrelocated("!io.netty.handler.codec.http", "!io.github.zzzyyylllty.kangeldungeon.dep.http")
        .replaceUnrelocated("!io.netty.handler.codec.rtsp", "!io.github.zzzyyylllty.kangeldungeon.dep.rtsp")
        .replaceUnrelocated("!io.netty.handler.codec.spdy", "!io.github.zzzyyylllty.kangeldungeon.dep.spdy")
        .replaceUnrelocated("!io.netty.handler.codec.http2", "!io.github.zzzyyylllty.kangeldungeon.dep.http2")
        .replaceUnrelocated("!org.tabooproject.fluxon","!io.github.zzzyyylllty.kangeldungeon.dep.fluxon")
        .replaceUnrelocated("!com.github.benmanes.caffeine","!io.github.zzzyyylllty.kangeldungeon.dep.caffeine")
        .replaceUnrelocated("!org.kotlincrypto","!io.github.zzzyyylllty.kangeldungeon.dep.kotlincrypto")
//        .replaceUnrelocated("!com.oracle.truffle","!io.github.zzzyyylllty.kangeldungeon.dep.truffle")
//        .replaceUnrelocated("!org.graalvm.polyglot","!io.github.zzzyyylllty.kangeldungeon.dep.polyglot")
    return replaced
}
