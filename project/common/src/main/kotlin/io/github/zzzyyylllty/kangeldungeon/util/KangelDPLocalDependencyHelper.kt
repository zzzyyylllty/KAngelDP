...
class KAngelDungeonLocalDependencyHelper {
...
fun replaceTestTexts(str: String): String {
    ...
    val replaced = str
        .replaceUnrelocated("!top.maplex.arim","!io.github.zzzyyylllty.kangeldungeon.library.arim")
        .replaceUnrelocated("!ink.ptms.um","!io.github.zzzyyylllty.kangeldungeon.library.um")
        .replaceUnrelocated("!com.alibaba", "!io.github.zzzyyylllty.kangeldungeon.library.alibaba")
        .replaceUnrelocated("!kotlinx.serialization", "!kotlinx.serialization170")
        .replaceUnrelocated("!io.github.projectunified.uniitem","!io.github.zzzyyylllty.kangeldungeon.library.uniitem")
        .replaceUnrelocated("!com.fasterxml.jackson","!io.github.zzzyyylllty.kangeldungeon.library.jackson")
        .replaceUnrelocated("!com.mojang.datafixers","!io.github.zzzyyylllty.kangeldungeon.library.datafixers")
        .replaceUnrelocated("!io.netty.handler.codec.http", "!io.github.zzzyyylllty.kangeldungeon.library.http")
        .replaceUnrelocated("!io.netty.handler.codec.rtsp", "!io.github.zzzyyylllty.kangeldungeon.library.rtsp")
        .replaceUnrelocated("!io.netty.handler.codec.spdy", "!io.github.zzzyyylllty.kangeldungeon.library.spdy")
        .replaceUnrelocated("!io.netty.handler.codec.http2", "!io.github.zzzyyylllty.kangeldungeon.library.http2")
        .replaceUnrelocated("!org.tabooproject.fluxon","!io.github.zzzyyylllty.kangeldungeon.library.fluxon")
        .replaceUnrelocated("!com.github.benmanes.caffeine","!io.github.zzzyyylllty.kangeldungeon.library.caffeine")
        .replaceUnrelocated("!org.kotlincrypto","!io.github.zzzyyylllty.kangeldungeon.library.kotlincrypto")
//        .replaceUnrelocated("!com.oracle.truffle","!io.github.zzzyyylllty.kangeldungeon.library.truffle")
//        .replaceUnrelocated("!org.graalvm.polyglot","!io.github.zzzyyylllty.kangeldungeon.library.polyglot")
    return replaced
}
