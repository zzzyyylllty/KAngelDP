...
class VersionHelper {
    ...
    val isKAngelDungeonPremium by lazy {
        try {
            val classInstance = Class.forName("io.github.zzzyyylllty.kangeldungeon.premium.PremiumHelper")
            return@lazy (classInstance != null)
        } catch (e: ClassNotFoundException) {
            return@lazy false
        } catch (e: Exception) {
            throw kotlin.RuntimeException("An error occurred while enabling PremiumHelper.", e)
        }
    }
